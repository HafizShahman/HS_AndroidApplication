...
import com.lailyyana.proposalapp.adapter.GroupMemberAdapter;
import com.lailyyana.proposalapp.model.GroupUser;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_view_proposal:
                ...
                Intent.putExtra("HOLD_PROPOSAL", hold_proposal);
